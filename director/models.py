...
class OfficeStaff(models.Model):
    ...
    is_active = models.BooleanField(default=True)
    adhaar_no = models.BigIntegerField(null=True,blank=True,unique=True)    # added as of 09Sep25 added unique 04Oct25
    pan_no = models.CharField(max_length=50,null=True,blank=True,unique=True)   # added as of 09Sep25 added unique 04Oct25
