        ...
        if serializer.is_valid():
            ...
            if role_name == "teacher":
                ...
                try:
                    ...
                    if student_year_level and student_year_level.level:
                        year_level_data = {
                ...
                try:
                    director = Director.objects.get(user=user, is_active=True)
                    role_id = director.id
                ...
                try:
                  staf=OfficeStaff.objects.get(user=user, is_active=True)
                  role_id=staf.id
                  role_key="staff_id"
